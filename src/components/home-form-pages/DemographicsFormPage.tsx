...
import { Demographics, HomeFormPageProps } from "@/lib/utils";
      ...
      <Card className="w-[40rem]">
          ...
          <CardContent>
                <div className="space-y-8">
                    ...
                    <div>
                        ...
                        <div className="mt-4 space-y-3">
                            {raceChoices.map(choice => (
                                <div className="flex items-center gap-3" key={choice.value}>
                                    <Checkbox id={choice.value} onCheckedChange={checked => {
                                        if (checked) {
                                            setDemographics(o => ({
                                                ...o, 
                                                races: [...(o.races ?? []), choice.value]
                                            }))
                                        } else {
                                            setDemographics(o => ({
                                                ...o, 
                    ...
                    <div>
                        <span className="font-semibold">In which country do you reside?</span>
                        <div className="mt-3 w-64">
                            <CountryDropdown onChange={country => {
                                setDemographics(o => ({
                                    ...o, 
