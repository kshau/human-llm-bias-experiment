...
export const demographicsChoices = {
...
export const surveyItemQuestions = {
	...
	pttForAI: [
		"Even though I may sometimes suffer the consequences of trusting AI, I still prefer to trust than not to trust them.",
		"I rarely trust AI because I can't handle the uncertainty.",
		"AI is competent.",
		"I am wary about the capabilities of AI.",
		"I don't expect that AI is willing to assist and support people.",
		"I feel that AI can be relied upon to do what they say they will do."
	],
	postTaskMDMTPart1: [
		"is competent",
		"is reliable",
